...
class cs_course_page extends StatefulWidget {
  final String searchQuery;

  const cs_course_page({Key? key, required this.searchQuery}) : super(key: key);

  @override
  State<cs_course_page> createState() => cs_course_pageState();
}

class cs_course_pageState extends State<cs_course_page> {
  @override
